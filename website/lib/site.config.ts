...
export const site = {
  ...
  services: [
    { name: "Growth Engine System", slug: "growth-engine-system", page: "/service/growth-engine/", blurb: "One coordinated marketing system covering SEO, AI search, your website, your Google Business Profile, reviews, campaigns, and tracking, run from a single plan so you don't have to manage separate vendors.", price: "From $2,500 one-time" , photo: "/images/stock/small-business-owner-using-laptop-5.jpeg", photoAlt: "Two cafe owners looking at their laptop together", more: { label: "3 ways to start: Blueprint, Guided Implementation or Managed Growth", href: "/service/growth-engine/#options" } },
    ...
    { name: "PPC Advertising Management", slug: "ppc-advertising-management", page: "/service/ppc-advertising-management/", blurb: "Google Ads campaigns built around your highest-value services, with focused landing pages, call and form tracking, and regular optimization.", price: "From $750/mo + ad spend" , photo: "/images/stock/marketing-analytics-dashboard-laptop-5.jpeg", photoAlt: "Laptop showing ad campaign performance charts" },
