...
**These are placeholders with a decent haircut.** Stock never shows the team, a real job, a before/after, or anything a visitor would read as proof of THIS business. Swap each one for a real photo as it arrives, then delete its row.

| File | Query | Source | Credit | Licence |
|------|-------|--------|--------|--------|
| `small-business-owner-using-laptop-1.jpeg` | small business owner using laptop | Pexels | Antoni Shkraba | Pexels licence - free commercial use, no attribution required |
| `small-business-owner-using-laptop-2.jpeg` | small business owner using laptop | Pexels | RDNE Stock project | Pexels licence - free commercial use, no attribution required |
| `small-business-owner-using-laptop-5.jpeg` | small business owner using laptop | Pexels | Ketut Subiyanto | Pexels licence - free commercial use, no attribution required |
| `marketing-analytics-dashboard-laptop-2.jpeg` | marketing analytics dashboard laptop | Pexels | Atlantic Ambience | Pexels licence - free commercial use, no attribution required |
| `marketing-analytics-dashboard-laptop-3.jpeg` | marketing analytics dashboard laptop | Pexels | Negative Space | Pexels licence - free commercial use, no attribution required |
| `marketing-analytics-dashboard-laptop-4.jpeg` | marketing analytics dashboard laptop | Pexels | Negative Space | Pexels licence - free commercial use, no attribution required |
| `marketing-analytics-dashboard-laptop-5.jpeg` | marketing analytics dashboard laptop | Pexels | Joshua Mayo | Pexels licence - free commercial use, no attribution required |
| `marketing-analytics-dashboard-laptop-6.jpeg` | marketing analytics dashboard laptop | Pexels | Lukas Blazek | Pexels licence - free commercial use, no attribution required |
| `consultant-meeting-small-business-owner-1.jpeg` | consultant meeting small business owner | Pexels | RDNE Stock project | Pexels licence - free commercial use, no attribution required |
| `smartphone-map-search-2.jpeg` | smartphone map search | Pexels | Pixabay | Pexels licence - free commercial use, no attribution required |
| `smartphone-map-search-4.jpg` | smartphone map search | Pexels | Ingo Joseph | Pexels licence - free commercial use, no attribution required |
